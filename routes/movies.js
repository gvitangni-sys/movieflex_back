...
async function ensureCatalogSeeded() {
  ...
  const movieMappings = [
    {
      image: "andalouse.jpg",
      video: "Kendji Girac - Andalouse (Clip Officiel).mp4",
      title: "Andalouse",
      description: "Clip officiel de Kendji Girac - Andalouse",
      genre: "Musique",
      year: 2024,
      rating: 9,
      duration: "3m 45s",
    ...
    {
      image: "dans_mes_bras.jpg",
      video: "Kendji Girac - Dans mes bras (en duo avec Dadju).mp4",
      title: "Dans mes bras",
      description: "Kendji Girac en duo avec Dadju - Dans mes bras",
      genre: "Musique",
      year: 2024,
      rating: 9,
      duration: "4m 12s",
    ...
    {
      image: "derniere_metro.jpg",
      video:
        "Kendji Girac - Dernier métro (en duo avec Gims) (Clip officiel).mp4",
      title: "Dernier métro",
      description: "Kendji Girac en duo avec Gims - Dernier métro",
      genre: "Musique",
      year: 2024,
      rating: 9,
      duration: "3m 58s",
    ...
    {
      image: "kendji_bebeto.jpg",
      video: "Kendji Girac - Bebeto (en duo avec Soolking) (Clip officiel).mp4",
      title: "Bebeto",
      description: "Kendji Girac en duo avec Soolking - Bebeto",
      genre: "Musique",
      year: 2024,
      rating: 9,
      duration: "3m 30s",
